...
training_mod = {
    ...
    # "log_name": "RC_shuffle_half_double_static_value",
    # "log_name": "RC_shuffle_half_double_static_value_nostart",
    # "log_name": "D3_shuffle_original_double_similar_start",
    # "log_name": "D3_shuffle_original_double_similar_nostart",
    # "log_name": "D3_shuffle_original_double_similar_both",
    # "log_name": "D3_original_double_similar_large_rate",
    # "log_name": "test_model",
    # "log_name": "D3_OD_deep_simple",
    # "log_name": "RC_OD_deep_simple_middle_rate",
    # "log_name": "D3_OD_simple_simple",
    # "log_name": "D3_OD_deep_no",
    # "log_name": "D3_OD_deep_no_middle_rate",
    # "log_name": "D3_OD_simple_no",
    # "log_name": "D3_OD_simple_simple_Large_shuffle",
    # "log_name": "D3_OD_deep_no_more_data",
    # "log_name": "D3_OD_deep_no_low_rate",
    # "log_name": "RC_shuffle_renew_best_simple_move_noend",
            ...
            while True:
                ...
                if (training_mod["return_node"] == True):
                    if (training_mod["testing_log"]):
                        if (training_mod["Double_learning"]):
                            testing_logger.info(
                        ...
                        elif (training_mod["half_double_learning"]):
                            testing_logger.info(
                                f" process_number {threadID} restart {restartcount} turn {turn} double_evaluation {root_node.exp_Ab} score {state.score} dir {dir} possible_move {root_node.available_actions}"
                            )
                ...
                if (training_mod["actual_value"] == False):
                    if (training_mod["play_method"] == "renew_children"):
                        if (training_mod["proportion_evaluation"] == True):
                            ...
                            for child_node in child_node_lis:
                                queue.put({'lastboard': child_node.state.board, 'target': child_node.exp_Ab})
                        elif (training_mod["Double_learning"]):
                            for child_node in child_node_lis:
                        ...
                        if lastboard is not None:
                            ...
                            if (training_mod["proportion_evaluation"] == True):
                                ...
                                queue.put({'lastboard': lastboard, 'target': ev_Ab})
                            else:
                                queue.put({'lastboard': lastboard, 'target': ev})
...
def trainer(queue, modelt, model_B, slow_control: tmp.Value, training_device_number=None, model_name = None):
    ...
    while True:
        ...
        if (training_mod["step_learning"] or training_mod["Double_learning"]):
        ...
        elif (training_mod["Original_double_learning"] or training_mod["half_double_learning"]):
            # only use modelt
...
if __name__ == '__main__':
    ...
    if (training_mod["load_weight"] == True):
        ...
        if (training_mod["Double_learning"] or training_mod["step_learning"]):
    ...
    if (training_mod["Original_double_learning"]):
        ...
        training_process1 = tmp.Process(target=trainer,
                                        args=(queue1, model_B, None, slow_control, another_device_number,"A"))
        training_process1.start()
    else:
        if (training_mod["keep_B"] == False):
